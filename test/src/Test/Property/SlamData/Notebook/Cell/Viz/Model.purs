...
module Test.Property.SlamData.Notebook.Cell.Viz.Model
  ( ArbModel()
  , runArbModel
  , check
  ) where
...
import Test.Property.SlamData.Notebook.Cell.Chart.ChartType (runArbChartType)
import Test.Property.SlamData.Notebook.Cell.Chart.ChartConfiguration (runArbChartConfiguration, checkChartConfigEquality)
