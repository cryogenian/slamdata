...
module Test.Property.Notebook.Cell.Model
  ( ArbCell()
  , runArbCell
  , check
  , checkCellEquality
...
import Notebook.Cell.Model (Model(), encode, decode)

import Test.StrongCheck (QC(), Result(..), Arbitrary, arbitrary, quickCheck, (<?>))

import Test.Property.ArbJson (runArbJson)
import Test.Property.Notebook.Cell.CellId (runArbCellId)
import Test.Property.Notebook.Cell.CellType (runArbCellType)
