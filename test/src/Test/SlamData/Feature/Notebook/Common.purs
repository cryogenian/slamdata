...
-- | (i.e. Test.SlamData.Feature.Notebook.Explore)
module Test.SlamData.Feature.Notebook.Common where
...
--
--checkNextCells :: SM.StrMap String -> SlamFeature Unit
--checkNextCells m = do
...
--
--
--checkInitial :: SlamFeature Unit -> SlamFeature Unit
...
--
--
--checkEmbedButton :: SlamFeature Unit
--checkEmbedButton = do
--  config <- getConfig
...
--checkIncorrect :: SlamFeature Element -> SlamFeature Unit
...
--
--checkTableEmpty :: SlamFeature Unit
--checkTableEmpty = do
--  config <- getConfig
