...
module Test.SlamData.Feature.Notebook.Contexts where
...
--
--import Test.SlamData.Feature.ActionSequence (keys)
--import Test.SlamData.Feature.Common
--import Test.SlamData.Feature.File hiding (test)
--import Test.SlamData.Feature.Log
import Test.SlamData.Feature.Monad
--import Test.SlamData.Feature.Notebook.Getters
--
--type Context = (SlamFeature Unit -> SlamFeature Unit)
--
--reloadAndSpyXHR :: SlamFeature Unit
--reloadAndSpyXHR = do
...
--
--
--cellHasRun :: SlamFeature Boolean
--cellHasRun = do
...
----    action
--
--tableChanged :: String -> SlamFeature Boolean
--tableChanged old = do
--  html <- getTable >>= getInnerHtml
--  pure $ html /= old
--
--afterTableChanged :: forall a. SlamFeature a -> SlamFeature a
...
--  pure res
--
--afterTableReload :: String -> SlamFeature Unit
