...
import Notebook.Cell.Download.Component.State
import Notebook.Cell.Download.Component.Query
import Notebook.Cell.Component
  (makeSingularCellComponent, makeQueryPrism, _DownloadState, _DownloadQuery)
import Notebook.Cell.CellType (cellName, cellGlyph, CellType(Download))
...
downloadButton state =
  ...
  where
  url :: String
  url = printPath Config.Paths.dataUrl
