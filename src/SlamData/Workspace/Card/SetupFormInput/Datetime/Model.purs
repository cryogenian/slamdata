module SlamData.Workspace.Card.SetupFormInput.Datetime.Model where
...
type Model = Maybe DatetimeR

initialModel ∷ Model
initialModel = Nothing

eqDatetimeR ∷ DatetimeR → DatetimeR → Boolean
eqDatetimeR r1 r2 =
  F.and
    [ r1.name ≡ r2.name
    , r1.value ≡ r2.value
...
eqModel (Just r1) (Just r2) = eqDatetimeR r1 r2
eqModel _ _ = false
...
decode js
  ...
  | otherwise = map Just do
    ...
    unless (fiType ≡ "datetime")
      $ throwError "This is not datetime form input setup"
    name ← obj .? "name"
    value ← obj .? "value"
    label ← obj .? "label"
