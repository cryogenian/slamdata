module SlamData.Workspace.Card.SetupFormInput.Text.Component.Query where
...
import SlamData.Workspace.Card.SetupFormInput.Text.Component.ChildSlot (ChildQuery, ChildSlot)
