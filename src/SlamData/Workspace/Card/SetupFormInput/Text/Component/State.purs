module SlamData.Workspace.Card.SetupFormInput.Text.Component.State where
...
import SlamData.Workspace.Card.SetupFormInput.Text.Component.Query (QueryC, Selection)
