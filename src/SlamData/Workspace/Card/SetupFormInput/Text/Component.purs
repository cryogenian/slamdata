...
import SlamData.Workspace.Card.SetupFormInput.Text.Component.ChildSlot as CS
import SlamData.Workspace.Card.SetupFormInput.Text.Component.State as ST
import SlamData.Workspace.Card.SetupFormInput.Text.Component.Query as Q
--import SlamData.Workspace.Card.SetupFormInput.Text.Model as M
...
textSetupComponent ∷ H.Component CC.CardStateP CC.CardQueryP Slam
textSetupComponent = CC.makeCardComponent
  { cardType: CT.SetupFormInput FIT.Text
  , component: H.parentComponent { render, eval, peek: Just (peek ∘ H.runChildF) }
  , initialState: H.parentState ST.initialState
  , _State: CC._SetupTextState
  , _Query: CC.makeQueryPrism' CC._SetupTextQuery
  }
...
render state =
  HH.div_
    [ renderHighLOD state
    , renderLowLOD (CT.cardIconDarkImg $ CT.SetupFormInput FIT.Text) left state.levelOfDetails
    ]
...
cardEval = case _ of
  ...
  CC.Save k → do
    ...
    pure $ k $ Card.SetupText model
  CC.Load (Card.SetupText (Just model)) next → do
    H.modify _
