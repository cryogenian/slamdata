module SlamData.Workspace.Card.SetupFormInput.Date.Component.Query where
...
import SlamData.Workspace.Card.SetupFormInput.Date.Component.ChildSlot (ChildQuery, ChildSlot)
