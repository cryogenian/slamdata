module SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.Query where
...
import SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.ChildSlot (ChildQuery, ChildSlot)
