module SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.State where
...
import SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.Query (QueryC, Selection)
