...
import SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.ChildSlot as CS
import SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.State as ST
import SlamData.Workspace.Card.SetupFormInput.Checkbox.Component.Query as Q
--import SlamData.Workspace.Card.SetupFormInput.Checkbox.Model as M
...
checkboxSetupComponent ∷ H.Component CC.CardStateP CC.CardQueryP Slam
checkboxSetupComponent = CC.makeCardComponent
  { cardType: CT.SetupFormInput FIT.Checkbox
  , component: H.parentComponent { render, eval, peek: Just (peek ∘ H.runChildF) }
  , initialState: H.parentState ST.initialState
  , _State: CC._SetupCheckboxState
  , _Query: CC.makeQueryPrism' CC._SetupCheckboxQuery
  }
...
render state =
  HH.div_
    [ renderHighLOD state
    , renderLowLOD (CT.cardIconDarkImg $ CT.SetupFormInput FIT.Checkbox) left state.levelOfDetails
    ]
...
cardEval = case _ of
  ...
  CC.Save k → do
    ...
    pure $ k $ Card.SetupCheckbox model
  CC.Load (Card.SetupCheckbox (Just model)) next → do
    H.modify _
