module SlamData.Workspace.Card.SetupFormInput.Numeric.Component.State where
...
import SlamData.Workspace.Card.SetupFormInput.Numeric.Component.Query (QueryC, Selection)
