module SlamData.Workspace.Card.SetupFormInput.Numeric.Component.Query where
...
import SlamData.Workspace.Card.SetupFormInput.Numeric.Component.ChildSlot (ChildQuery, ChildSlot)
