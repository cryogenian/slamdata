...
import SlamData.Workspace.Card.SetupFormInput.Numeric.Component.ChildSlot as CS
import SlamData.Workspace.Card.SetupFormInput.Numeric.Component.State as ST
import SlamData.Workspace.Card.SetupFormInput.Numeric.Component.Query as Q
--import SlamData.Workspace.Card.SetupFormInput.Numeric.Model as M
...
numericSetupComponent ∷ H.Component CC.CardStateP CC.CardQueryP Slam
numericSetupComponent = CC.makeCardComponent
  { cardType: CT.SetupFormInput FIT.Numeric
  , component: H.parentComponent { render, eval, peek: Just (peek ∘ H.runChildF) }
  , initialState: H.parentState ST.initialState
  , _State: CC._SetupNumericState
  , _Query: CC.makeQueryPrism' CC._SetupNumericQuery
  }
...
render state =
  HH.div_
    [ renderHighLOD state
    , renderLowLOD (CT.cardIconDarkImg $ CT.SetupFormInput FIT.Numeric) left state.levelOfDetails
    ]
...
cardEval = case _ of
  ...
  CC.Save k → do
    ...
    pure $ k $ Card.SetupNumeric model
  CC.Load (Card.SetupNumeric (Just model)) next → do
    H.modify _
