...
module SlamData.Workspace.Card.BuildChart.Parallel.Component.State where
...
import SlamData.Workspace.Card.BuildChart.Parallel.Component.Query (QueryC, Selection)
