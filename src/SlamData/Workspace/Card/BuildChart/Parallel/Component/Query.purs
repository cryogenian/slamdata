...
module SlamData.Workspace.Card.BuildChart.Parallel.Component.Query where
...
import SlamData.Workspace.Card.BuildChart.Parallel.Component.ChildSlot (ChildQuery, ChildSlot)
