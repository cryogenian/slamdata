...
graphBuilderComponent ∷ CC.CardOptions → H.Component CC.CardStateP CC.CardQueryP Slam
graphBuilderComponent options = CC.makeCardComponent
  { options
...
render state =
  HH.div_
    [ renderHighLOD state
    , renderLowLOD (CT.cardIconDarkImg $ CT.ChartOptions CHT.Graph) left state.levelOfDetails
    ]
