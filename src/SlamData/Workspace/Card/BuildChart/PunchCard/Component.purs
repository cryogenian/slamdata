...
punchCardBuilderComponent ∷ H.Component CC.CardStateP CC.CardQueryP Slam
punchCardBuilderComponent = CC.makeCardComponent
...
render state =
  HH.div_
    [ renderHighLOD state
    , renderLowLOD (CT.darkCardGlyph $ CT.ChartOptions CHT.PunchCard) left state.levelOfDetails
    ]
