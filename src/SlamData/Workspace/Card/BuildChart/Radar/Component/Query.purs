...
module SlamData.Workspace.Card.BuildChart.Radar.Component.Query where
...
import SlamData.Workspace.Card.BuildChart.Radar.Component.ChildSlot (ChildQuery, ChildSlot)
