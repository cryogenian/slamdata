...
module SlamData.Workspace.Card.Setups.Chart.Radar.Component.Query where
...
import SlamData.Workspace.Card.Setups.Chart.Radar.Component.ChildSlot (ChildQuery, ChildSlot)
