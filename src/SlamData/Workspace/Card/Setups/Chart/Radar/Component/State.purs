...
module SlamData.Workspace.Card.Setups.Chart.Radar.Component.State where
...
import SlamData.Workspace.Card.Setups.Chart.Radar.Component.Query (QueryC, Selection)
