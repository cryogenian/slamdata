...
module SlamData.Workspace.Card.Setups.FormInput.Checkbox.Model
  ( encode
  , decode
...
import SlamData.Workspace.Card.Setups.FormInput.Labeled.Model
  ( Model
  , initialModel
  , eqModel
  , genModel
  )
import SlamData.Workspace.Card.Setups.FormInput.Labeled.Model as Lbl
