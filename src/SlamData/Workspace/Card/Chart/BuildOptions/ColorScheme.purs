...
module SlamData.Workspace.Card.Chart.BuildOptions.ColorScheme where
...
getColorScheme ∷ String → Array Color
getColorScheme = case _ of
  "sequential: blue green" → blueGreen
  "sequential: blue purple" → bluePurple
  "sequential: green blue" → greenBlue
  "sequential: orange red" → orangeRed
  "sequential: purple blue" → purpleBlue
  "sequential: purple blue green" → purpleBlueGreen
  "sequential: purple red" → purpleRed
  "sequential: red purple" → redPurple
  "sequential: yellow green" → yellowGreen
  "sequential: yellow green blue" → yellowGreenBlue
  "sequential: yellow orange brown" → yellowOrangeBrown
  "sequential: yellow orange red" → yellowOrangeRed
  ...
  "diverging: brown-blue green" → brownToBlueGreen
  "diverging: pink-yellow green" → pinkToYellowGreen
  "diverging: purple-green" → purpleToGreen
  "diverging: purple-orange" → purpleToOrange
  "diverging: red-blue" → redToBlue
  "diverging: red-yellow-blue" → redToYellowToBlue
  _ → redToBlue
