...
import SlamData.Quasar.Auth.Authentication (RequestIdTokenBus, fromEither, getIdToken)
...
eval requestNewIdTokenBus (Init next) = next <$ do
  isLogged ← map isJust $ H.fromAff $ fromEither <$> (getIdToken requestNewIdTokenBus)
