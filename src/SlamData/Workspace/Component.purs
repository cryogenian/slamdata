...
comp ∷ ∀ r. (Bus (write ∷ Cap | r) (AVar EIdToken)) → Wiring → SignInBus → H.Component StateP QueryP Slam
comp requestNewIdTokenBus wiring signInBus =
  ...
  rootDeck path = Model.getRoot requestNewIdTokenBus (path </> Pathy.file "index")
