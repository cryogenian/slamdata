...
module SlamData.Notebook.Card.Chart.ChartOptions.Bar where
...
import SlamData.Notebook.Card.Chart.ChartOptions.Common (Key, PieBarData, commonNameMap, keyCategory, colors, mixAxisLabelAngleAndFontSize, buildChartAxises, pieBarData)
