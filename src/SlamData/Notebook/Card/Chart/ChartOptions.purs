...
module SlamData.Notebook.Card.Chart.ChartOptions (buildOptions) where
...
import SlamData.Notebook.Card.Chart.ChartOptions.Bar (buildBar)
import SlamData.Notebook.Card.Chart.ChartOptions.Line (buildLine)
import SlamData.Notebook.Card.Chart.ChartOptions.Pie (buildPie)
