...
module SlamData.Notebook.Card.Chart.ChartConfiguration where
...
import SlamData.Notebook.Card.Chart.Aggregation (Aggregation)
import SlamData.Notebook.Card.Chart.Axis (dependsOn)
