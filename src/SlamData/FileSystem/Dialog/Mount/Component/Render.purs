...
module SlamData.FileSystem.Dialog.Mount.Component.Render (render) where
...
import Halogen.HTML.Events.Types (Event(), KeyboardEvent()) as E
...
import SlamData.Render.Common (fadeWhen, closeButton)
...
input :: forall p. State -> TraversalP State String
                  -> Array (Cp.InputProp Query) -> HTML p Query
